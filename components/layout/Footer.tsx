            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="col-span-1 md:col-span-1 space-y-4">
                        <h2 className="text-3xl font-bold font-poppins text-white tracking-tight">MANTHAN<span className="text-neon-magenta">.</span></h2>
                        <p className="text-sm leading-relaxed max-w-xs cursor-default">
                            The Annual Management & Cultural Fest of TISS Mumbai. <br />
                            <span className="text-soft-lavender italic opacity-80 font-medium tracking-wide">Dare. Dream. Discover.</span>
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Link href="/about" className="hover:text-neon-magenta hover:pl-2 transition-all duration-300 block">About Us</Link></li>
                            <li><Link href="/events" className="hover:text-neon-magenta hover:pl-2 transition-all duration-300 block">All Events</Link></li>
                            <li><Link href="/gallery" className="hover:text-neon-magenta hover:pl-2 transition-all duration-300 block">Gallery</Link></li>
                            <li><Link href="/contact" className="hover:text-neon-magenta hover:pl-2 transition-all duration-300 block">Contact</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Link href="/events?category=flagship" className="hover:text-grad-end hover:pl-2 transition-all duration-300 block">Flagship Events</Link></li>
                            <li><Link href="/events?category=cultural" className="hover:text-soft-lavender hover:pl-2 transition-all duration-300 block">Cultural</Link></li>
                            <li><Link href="/events?category=management" className="hover:text-grad-mid hover:pl-2 transition-all duration-300 block">Management</Link></li>
                            <li><Link href="/events?category=sports" className="hover:text-grad-start hover:pl-2 transition-all duration-300 block">Sports</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li className="flex items-start gap-3">
                                <span className="text-soft-lavender font-bold">HQ:</span>
